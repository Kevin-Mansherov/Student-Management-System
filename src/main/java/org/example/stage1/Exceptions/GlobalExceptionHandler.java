...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(StudentAndIdMisMatch.class)
    public ResponseEntity<StandardResponse> handleStudentAndIdMisMatch(StudentAndIdMisMatch ex, WebRequest request) {
        Map<String,String> details = new HashMap<>();
